...
public class printTaxAnalysis {
    ...
    public printTaxAnalysis(SaleMaster sm, Enterprise e, Retailer r) {
        this.sm = sm;
        this.e = e;
        this.r = r;
        ...
        if (printJob.printDialog())
        {
            ...
            {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(null,"printTaxAnalysis ex?= "+ex,"Error Found",JOptionPane.ERROR_MESSAGE);
            }
        }
...
//        }
    ...
    private class IntroPage implements Printable {
        ...
        public int print(Graphics g, PageFormat pageFormat, int page) {
            ...
            //Outer Rectangle
            g2d.drawRoundRect(leftbound, (int)(titleY+20), 495, 300, 8, 8);
            ...
            g2d.drawLine(leftbound, (int)(titleY+290), rightbound, (int)(titleY+290));
            ...
            */
            ...
            for ( int i = 0; i < endposes.length-1; i++ ) {
                g2d.drawLine(prev+endposes[i]+50, (int)(titleY+20), prev+endposes[i]+50, (int)(titleY+320));
                prev += endposes[i];
            }
            ...
            if(print2wiseFlag)
            {
                ...
                {
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(null,"PrintTaxAnalysis ex?= "+ex,
                ...
                // Total
                titleY = 503;
                String data[] = { "", "Total", "", MyNumberFormat.rupeeFormat(Double.parseDouble(sm.getNetcgst())), "", 
                    MyNumberFormat.rupeeFormat(Double.parseDouble(sm.getNetsgst())), 
                    MyNumberFormat.rupeeFormat(Double.parseDouble(sm.getNetcgst()) + Double.parseDouble(sm.getNetsgst())) };
                startpos = leftbound;
                endpos = startpos + endposes[0];
                for ( i = 0; i < endposes.length - 1; i++ ) {
                    titleText = data[i];
